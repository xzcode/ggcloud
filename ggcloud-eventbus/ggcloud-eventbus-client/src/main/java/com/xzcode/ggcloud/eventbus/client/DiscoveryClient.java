...
import com.xzcode.ggcloud.eventbus.client.handler.AddServiceRespHandler;
import com.xzcode.ggcloud.eventbus.client.handler.AnthRespHandler;
import com.xzcode.ggcloud.eventbus.client.handler.ServiceListRespHandler;
import com.xzcode.ggcloud.eventbus.client.handler.ServiceUnregisterRespHandler;
import com.xzcode.ggcloud.eventbus.client.handler.ServiceUpdateRespHandler;
...
public class DiscoveryClient {
	...
	public DiscoveryClient(EventbusClientConfig config) {
		this.config = config;
	...
	public EventbusClientConfig getConfig() {
		return config;
	}
