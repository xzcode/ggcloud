 ...
 *
 */
public class RouterDecodeHandler implements IDecodeHandler{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(RouterDecodeHandler.class);
	...
	public RouterDecodeHandler() {
		
	}
	
	public RouterDecodeHandler(GGConfig config) {
		super();
		this.config = config;
	}
