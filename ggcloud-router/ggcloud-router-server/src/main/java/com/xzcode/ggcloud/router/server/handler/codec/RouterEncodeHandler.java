package com.xzcode.ggcloud.router.server.handler.codec;
 ...
 * 2018-12-07 13:38:22
 */
public class RouterEncodeHandler implements IEncodeHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(RouterEncodeHandler.class);
	...
	public RouterEncodeHandler() {
	}
	
	
	public RouterEncodeHandler(GGConfig config) {
		super();
		this.config = config;
	}
